...
(function (a) {
    a.fn.supersubs = function (b) {
        ...
        return this.each(function () {
            var b = a(this), e = a.meta ? a.extend({}, c, b.data()) : c, f = b.find("ul").show(), l = a('<li id="menu-fontsize">&#8212;</li>').css({
                padding: 0,
                position: "absolute",
                top: "-999em",
                width: "auto"
            ...
            f.each(function (b) {
                b = a(this);
                var c = b.children(), d = c.children("a"), f = c.css("white-space", "nowrap").css("float");
                ...
                c.css({"float": f, width: "100%", "white-space": "normal"}).each(function () {
                    var b = a(this).children("ul"), c = void 0 !== b.css("left") ? "left" : "right";
                    b.css(c, "100%")
                })
            }).hide()
        })
...
(function (a) {
    var b = 0, c = 0, d = 0, e = 0, f = "ontouchstart" in window || 0 < navigator.msMaxTouchPoints, l = "onorientationchange" in window, g = !1, n = !1, r = !1, v = !1, u = !1, y = "pointer", A = "pointer", W = [], T = [], ma = [], Y = [], J = [], ba = [], L = [], p = [], x = [], ca = [], ha = [], m = {
        showScrollbar: function (b, c) {
            b.scrollbarHide && a("." + c).css({
                opacity: b.scrollbarOpacity,
                filter: "alpha(opacity:" + 100 * b.scrollbarOpacity + ")"
            })
        }, hideScrollbar: function (a, b, c, d, e, k, f, g, l, n) {
            if (a.scrollbar && a.scrollbarHide)for (var h = c; h < c + 25; h++)b[b.length] = m.hideScrollbarIntervalTimer(10 * h, d[c], (c + 24 - h) / 24, e, k, f, g, l, n, a)
        }, hideScrollbarInterval: function (b, c, d, f, g, k, l, n, r) {
            e = -1 * b / x[n] * (g - k - l - f);
        ...
        }, slowScrollHorizontalInterval: function (b, c, d, f, g, k, l, n, r, A, E, M, u, P, B, w, v, q, C) {
            if (C.infiniteSlider) {
                if (d <= -1 * x[w]) {
                    var h = a(b).width();
                    if (d <= -1 * ca[w]) {
                        ...
                        var F = 0, z = m.getSliderOffset(a(c[0]), "x");
                        a(c).each(function (a) {
                            m.getSliderOffset(this, "x") < z && (z = m.getSliderOffset(this, "x"), F = a)
                        });
                        u = p[w] + h;
                        m.setSliderOffset(a(c)[F], u);
                        p[w] = -1 * M[1] + v;
                        x[w] = p[w] + h - k;
                        M.splice(0, 1);
                        M.splice(M.length, 0, -1 * u + v);
                        L[w]++
                    }
                }
                if (d >= -1 * p[w] || 0 <= d) {
                    h = a(b).width();
                    if (0 < d)for (I = -1 * E[0], a(c).each(function (b) {
                        m.setSliderOffset(a(c)[b], I + v);
                        b < M.length && (M[b] = -1 * I);
                        I += B[b]
                    }), d -= -1 * M[0], p[w] = -1 * M[0] + v, x[w] = p[w] + h - k, L[w] = P; 0 < -1 * M[0] - h + v;) {
                        var Q = 0, K = m.getSliderOffset(a(c[0]), "x");
                        a(c).each(function (a) {
                            m.getSliderOffset(this, "x") > K && (K = m.getSliderOffset(this, "x"), Q = a)
                        });
                        u = p[w] - B[Q];
                        m.setSliderOffset(a(c)[Q], u);
                        M.splice(0, 0, -1 * u + v);
                    ...
                    0 > d && (Q = 0, K = m.getSliderOffset(a(c[0]), "x"), a(c).each(function (a) {
                        m.getSliderOffset(this, "x") > K && (K = m.getSliderOffset(this, "x"), Q = a)
                    }), u = p[w] - B[Q], m.setSliderOffset(a(c)[Q], u), M.splice(0, 0, -1 * u + v), M.splice(M.length - 1, 1), p[w] = -1 * M[0] + v, x[w] = p[w] + h - k, L[w]--)
                }
            }
            E = !1;
            k = m.calcActiveOffset(C, d, M, k, L[w], P, A, w);
            u = (k + L[w] + P) % P;
            C.infiniteSlider ? u != ba[w] && (E = !0) : k != J[w] && (E = !0);
            if (E && (P = new m.args("change", C, b, a(b).children(":eq(" + u + ")"), u, q), a(b).parent().data("args", P), "" != C.onSlideChange)) C.onSlideChange(P);
            J[w] = k;
            ba[w] = u;
            d = Math.floor(d);
            m.setSliderOffset(b, d);
            C.scrollbar && (e = Math.floor((-1 * d - p[w] + v) / (x[w] - p[w] + v) * (l - n - g)), b = g - r, d >= -1 * p[w] + v ? (b = g - r - -1 * e, m.setSliderOffset(a("." + f), 0)) : (d <= -1 * x[w] + 1 && (b = l - n - r - e), m.setSliderOffset(a("." + f), e)), a("." + f).css({width: b + "px"}))
        }, slowScrollHorizontal: function (b, c, d, e, f, k, g, l, n, r, u, v, A, P, B, w, y, q, C, D, O) {
            var h = m.getSliderOffset(b, "x");
            k = [];
            var I = 0, z = 25 / 1024 * l;
            frictionCoefficient = O.frictionCoefficient;
            elasticFrictionCoefficient = O.elasticFrictionCoefficient;
            snapFrictionCoefficient = O.snapFrictionCoefficient;
            f > O.snapVelocityThreshold && O.snapToChildren && !C ? I = 1 : f < -1 * O.snapVelocityThreshold && O.snapToChildren && !C && (I = -1);
            f < -1 * z ? f = -1 * z : f > z && (f = z);
            a(b)[0] !== a(q)[0] && (I *= -1, f *= -2);
            q = L[B];
            if (O.infiniteSlider)var F = p[B], Q = x[B];
            C = [];
            for (var z = [], K = 0; K < A.length; K++)C[K] = A[K], K < c.length && (z[K] = m.getSliderOffset(a(c[K]), "x"));
            for (; 1 < f || -1 > f;) {
                f *= frictionCoefficient;
                h += f;
                (h > -1 * p[B] || h < -1 * x[B]) && !O.infiniteSlider && (f *= elasticFrictionCoefficient, h += f);
                if (O.infiniteSlider) {
                    if (h <= -1 * Q) {
                        for (var Q = a(b).width(), E = 0, M = z[0], K = 0; K < z.length; K++)z[K] < M && (M = z[K], E = K);
                        K = F + Q;
                        z[E] = K;
                        F = -1 * C[1] + D;
                        Q = F + Q - l;
                        C.splice(0, 1);
                        C.splice(C.length, 0, -1 * K + D);
                        q++
                    }
                    if (h >= -1 * F) {
                        Q = a(b).width();
                        E = 0;
                        M = z[0];
                        for (K = 0; K < z.length; K++)z[K] > M && (M = z[K], E = K);
                        K = F - P[E];
                        z[E] = K;
                        C.splice(0, 0, -1 * K + D);
            ...
            z = !1;
            f = m.calcActiveOffset(O, h, C, l, q, y, J[B], B);
            O.snapToChildren && (O.infiniteSlider ? (f + q + y) % y != ba[B] && (z = !0) : f != J[B] && (z = !0), 0 > I && !z ? (f++, f >= A.length && !O.infiniteSlider && (f = A.length - 1)) : 0 < I && !z && (f--, 0 > f && !O.infiniteSlider && (f = 0)));
            if (O.snapToChildren || (h > -1 * p[B] || h < -1 * x[B]) && !O.infiniteSlider) {
                for ((h > -1 * p[B] || h < -1 * x[B]) && !O.infiniteSlider ? k.splice(0, k.length) : (k.splice(.1 * k.length, k.length), h = 0 < k.length ? k[k.length - 1] : h); h < C[f] - .5 || h > C[f] + .5;)h = (h - C[f]) * snapFrictionCoefficient + C[f], k[k.length] = h;
                k[k.length] = C[f]
            }
            I = 1;
            0 != k.length % 2 && (I = 0);
            ...
            q = (f + q + y) % y;
            F = 0;
            for (h = I; h < k.length; h += 2)if (h == I || 1 < Math.abs(k[h] - F) || h >= k.length - 2) F = k[h], d[d.length] = m.slowScrollHorizontalIntervalTimer(10 * h, b, c, k[h], e, g, l, n, r, u, f, v, A, w, y, P, B, D, q, O);
            F = (f + L[B] + y) % y;
            "" != O.onSlideComplete && 1 < k.length && (d[d.length] = m.onSlideCompleteTimer(10 * (h + 1), O, b, a(b).children(":eq(" + F + ")"), q, B));
            Y[B] = d;
            m.hideScrollbar(O, d, h, k, e, g, l, r, u, B)
            ...
            var d;
            c = "x" == c ? 4 : 5;
            if (!g || n || r) d = parseInt(a(b).css("left"), 10); else {
                d = ["-webkit-transform", "-moz-transform", "transform"];
                for (var e, f = 0; f < d.length; f++)if (void 0 != a(b).css(d[f]) && 0 < a(b).css(d[f]).length) {
                    e = a(b).css(d[f]).split(",");
                    break
                }
            ...
            c = parseInt(c, 10);
            !g || n || r ? a(b).css({left: c + "px"}) : a(b).css({
            ...
            null != navigator.userAgent.match("WebKit") ? (y = "-webkit-grab", A = "-webkit-grabbing") : null != navigator.userAgent.match("Gecko") ? (u = !0, y = "move", A = "-moz-grabbing") : null != navigator.userAgent.match("MSIE 7") ? v = n = !0 : null != navigator.userAgent.match("MSIE 8") ? v = r = !0 : null != navigator.userAgent.match("MSIE 9") && (v = !0)
            ...
            return h
        }, changeSlide: function (b, c, d, e, f, g, l, n, r, u, p, v, A, y, B, w, x, q) {
            m.autoSlidePause(y);
            for (var h = 0; h < e.length; h++)clearTimeout(e[h]);
            var k = Math.ceil(q.autoSlideTransTimer / 10) + 1, I = m.getSliderOffset(c, "x"), F = v[b], z = F - I;
            if (q.infiniteSlider)for (b = (b - L[y] + 2 * w) % w, h = !1, 0 == b && 2 == w && (b = w, v[b] = v[b - 1] - a(d).eq(0).outerWidth(!0), h = !0), F = v[b], z = F - I, F = [v[b] - a(c).width(), v[b] + a(c).width()], h && v.splice(v.length - 1, 1), h = 0; h < F.length; h++)Math.abs(F[h] - I) < Math.abs(z) && (z = F[h] - I);
            var F = [], K;
            m.showScrollbar(q, f);
            for (h = 0; h <= k; h++)K = h, K /= k, K--, K = I + z * (Math.pow(K, 5) + 1), F[F.length] = K;
            k = (b + L[y] + w) % w;
            for (h = I = 0; h < F.length; h++) {
                if (0 == h || 1 < Math.abs(F[h] - I) || h >= F.length - 2) I = F[h], e[h] = m.slowScrollHorizontalIntervalTimer(10 * (h + 1), c, d, F[h], f, g, l, n, r, u, b, p, v, B, w, A, y, x, k, q);
                0 == h && "" != q.onSlideStart && (z = (J[y] + L[y] + w) % w, q.onSlideStart(new m.args("start", q, c, a(c).children(":eq(" + z + ")"), z, b)))
            }
            I = !1;
            q.infiniteSlider ? k != ba[y] && (I = !0) : b != J[y] && (I = !0);
            I && "" != q.onSlideComplete && (e[e.length] = m.onSlideCompleteTimer(10 * (h + 1), q, c, a(c).children(":eq(" + k + ")"), k, y));
            Y[y] = e;
            m.hideScrollbar(q, e, h, F, f, g, l, r, u, y);
            m.autoSlide(c, d, e, f, g, l, n, r, u, p, v, A, y, B, w, x, q)
        }, autoSlide: function (a, b, c, d, e, f, g, l, n, r, v, u, p, y, A, w, x) {
            if (!T[p].autoSlide)return !1;
            m.autoSlidePause(p);
            W[p] = setTimeout(function () {
                !x.infiniteSlider && J[p] > v.length - 1 && (J[p] -= A);
                m.changeSlide((J[p] + L[p] + v.length + 1) % v.length, a, b, c, d, e, f, g, l, n, r, v, u, p, y, A, w, x);
                m.autoSlide(a, b, c, d, e, f, g, l, n, r, v, u, p, y, A, w, x)
            }, x.autoSlideTimer + x.autoSlideTransTimer)
        }, autoSlidePause: function (a) {
            clearTimeout(W[a])
        }, isUnselectable: function (b, c) {
            return "" != c.unselectableSelector && 1 == a(b).closest(c.unselectableSelector).length ? !0 : !1
        }, slowScrollHorizontalIntervalTimer: function (a, b, c, d, e, f, g, l, n, r, v, p, u, y, A, w, x, q, C, D) {
            return setTimeout(function () {
                m.slowScrollHorizontalInterval(b, c, d, e, f, g, l, n, r, v, p, u, y, A, w, x, q, C, D)
            }, a)
        }, onSlideCompleteTimer: function (a, b, c, d, e, f) {
            return setTimeout(function () {
                m.onSlideComplete(b, c, d, e, f)
            }, a)
        }, hideScrollbarIntervalTimer: function (a, b, c, d, e, f, g, l, n, r) {
            return setTimeout(function () {
                m.hideScrollbarInterval(b, c, d, e, f, g, l, n, r)
            }, a)
        ...
        init: function (z, u) {
            ...
            return a(u).each(function (g) {
                function I() {
                    ...
                    ka = [];
                    R = [];
                    h.responsiveSlides && a(H).css("width", "");
                    x[k] = 0;
                    t = [];
                    w = a(C).parent().width();
                    D = a(C).outerWidth(!0);
                    h.responsiveSlideContainer && (D = a(C).outerWidth(!0) > w ? w : a(C).width());
                    a(C).css({
                    ...
                    for (var b = 0; b < H.length; b++) {
                        ...
                        var c = R[b];
                        h.responsiveSlides && (R[b] > D ? (c = D + -1 * (R[b] - ka[b]), ka[b] = c, R[b] = D) : c = ka[b], a(H[b]).css({width: c}));
                        a(H[b]).css({webkitBackfaceVisibility: "hidden", overflow: "hidden", position: "absolute"});
                        t[b] = -1 * x[k];
                        x[k] = x[k] + c + (R[b] - ka[b])
                    }
                    h.snapSlideCenter && (q = .5 * (D - R[0]), h.responsiveSlides && R[0] > D && (q = 0));
                    ca[k] = 2 * x[k];
                    for (b = 0; b < H.length; b++)m.setSliderOffset(a(H[b]), -1 * t[b] + x[k] + q), t[b] -= x[k];
                    if (!h.infiniteSlider && !h.snapSlideCenter) {
                        for (b = 0; b < t.length && !(t[b] <= -1 * (2 * x[k] - D)); b++)Da = b;
                        t.splice(Da + 1, t.length);
                        t[t.length] = -1 * (2 * x[k] - D)
                    }
                    for (b = 0; b < t.length; b++)X[b] = t[b];
                    va && (T[k].startAtSlide = T[k].startAtSlide > t.length ? t.length : T[k].startAtSlide, h.infiniteSlider ? (T[k].startAtSlide = (T[k].startAtSlide - 1 + N) % N, J[k] = T[k].startAtSlide) : (T[k].startAtSlide = 0 > T[k].startAtSlide - 1 ? t.length - 1 : T[k].startAtSlide, J[k] = T[k].startAtSlide - 1), ba[k] = J[k]);
                    p[k] = x[k] + q;
                    a(G).css({
                        position: "relative",
                        cursor: y,
                    ...
                    ea = x[k];
                    x[k] = 2 * x[k] - D + 2 * q;
                    (fa = ea + q < D || 0 == D ? !0 : !1) && a(G).css({cursor: "default"});
                    Z = a(C).parent().outerHeight(!0);
                    O = a(C).height();
                    h.responsiveSlideContainer && (O = O > Z ? Z : O);
                    a(C).css({height: O});
                    m.setSliderOffset(G, t[J[k]]);
                    if (h.infiniteSlider && !fa) {
                        b = m.getSliderOffset(a(G), "x");
                        for (c = (L[k] + N) % N * -1; 0 > c;) {
                            var d = 0, e = m.getSliderOffset(a(H[0]), "x");
                            a(H).each(function (a) {
                            ...
                            x[k] = p[k] + ea - D;
                            t.splice(0, 1);
                            t.splice(t.length, 0, -1 * f + q);
                            c++
                        }
                        for (; 0 < -1 * t[0] - ea + q && h.snapSlideCenter && va;) {
                            var g = 0, I = m.getSliderOffset(a(H[0]), "x");
                            a(H).each(function (a) {
                                m.getSliderOffset(this, "x") > I && (I = m.getSliderOffset(this, "x"), g = a)
                            });
                            f = p[k] - R[g];
                        ...
                        for (; b <= -1 * x[k];)d = 0, e = m.getSliderOffset(a(H[0]), "x"), a(H).each(function (a) {
                            m.getSliderOffset(this, "x") < e && (e = m.getSliderOffset(this, "x"), d = a)
                        }), f = p[k] + ea, m.setSliderOffset(a(H)[d], f), p[k] = -1 * t[1] + q, x[k] = p[k] + ea - D, t.splice(0, 1), t.splice(t.length, 0, -1 * f + q), L[k]++, J[k]--
                    }
                    m.setSliderOffset(G, t[J[k]]);
                    h.desktopClickDrag || a(G).css({cursor: "default"});
                    h.scrollbar && (a("." + U).css({
                        margin: h.scrollbarMargin,
                        overflow: "hidden",
                        display: "none"
                    }), a("." + U + " ." + E).css({border: h.scrollbarBorder}), S = parseInt(a("." + U).css("marginLeft")) + parseInt(a("." + U).css("marginRight")), V = parseInt(a("." + U + " ." + E).css("borderLeftWidth"), 10) + parseInt(a("." + U + " ." + E).css("borderRightWidth"), 10), P = "" != h.scrollbarContainer ? a(h.scrollbarContainer).width() : D, B = D / ea * (P - S), h.scrollbarHide || (wa = h.scrollbarOpacity), a("." + U).css({
                        position: "absolute",
                        left: 0,
                        width: P - S + "px",
                        margin: h.scrollbarMargin
                    }), "top" == h.scrollbarLocation ? a("." + U).css("top", "0") : a("." + U).css("bottom", "0"), a("." + U + " ." + E).css({
                    ...
                    }), m.setSliderOffset(a("." + U + " ." + E), Math.floor((-1 * t[J[k]] - p[k] + q) / (x[k] - p[k] + q) * (P - S - B))), a("." + U).css({display: "block"}), M = a("." + U + " ." + E), W = a("." + U));
                    h.scrollbarDrag && !fa && a("." + U + " ." + E).css({cursor: y});
                    h.infiniteSlider && (aa = (x[k] + D) / 3);
                    "" != h.navSlideSelector && a(h.navSlideSelector).each(function (b) {
                        ...
                        a(this).unbind(da).bind(da, function (c) {
                            ...
                            m.changeSlide(b, G, H, z, E, B, D, P, S, V, X, t, R, k, aa, N, q, h)
                        })
                    });
                    "" != h.navPrevSelector && (a(h.navPrevSelector).css({cursor: "pointer"}), a(h.navPrevSelector).unbind(da).bind(da, function (b) {
                        "touchstart" == b.type ? a(this).unbind("click.iosSliderEvent") : a(this).unbind("touchstart.iosSliderEvent");
                        da = b.type + ".iosSliderEvent";
                        b = (J[k] + L[k] + N) % N;
                        (0 < b || h.infiniteSlider) && m.changeSlide(b - 1, G, H, z, E, B, D, P, S, V, X, t, R, k, aa, N, q, h)
                    }));
                    "" != h.navNextSelector && (a(h.navNextSelector).css({cursor: "pointer"}), a(h.navNextSelector).unbind(da).bind(da, function (b) {
                        "touchstart" == b.type ? a(this).unbind("click.iosSliderEvent") : a(this).unbind("touchstart.iosSliderEvent");
                        da = b.type + ".iosSliderEvent";
                        b = (J[k] + L[k] + N) % N;
                        (b < t.length - 1 || h.infiniteSlider) && m.changeSlide(b + 1, G, H, z, E, B, D, P, S, V, X, t, R, k, aa, N, q, h)
                    }));
                    h.autoSlide && !fa && "" != h.autoSlideToggleSelector && (a(h.autoSlideToggleSelector).css({cursor: "pointer"}), a(h.autoSlideToggleSelector).unbind(da).bind(da, function (b) {
                        "touchstart" == b.type ? a(this).unbind("click.iosSliderEvent") : a(this).unbind("touchstart.iosSliderEvent");
                        da = b.type + ".iosSliderEvent";
                        na ? (m.autoSlide(G, H, z, E, B, D, P, S, V, X, t, R, k, aa, N, q, h), na = !1, a(h.autoSlideToggleSelector).removeClass("on")) : (m.autoSlidePause(k), na = !0, a(h.autoSlideToggleSelector).addClass("on"))
                    }));
                    m.autoSlide(G, H, z, E, B, D, P, S, V, X, t, R, k, aa, N, q, h);
                    a(C).bind("mouseleave.iosSliderEvent", function () {
                        if (na)return !0;
                        m.autoSlide(G, H, z, E, B, D, P, S, V, X, t, R, k, aa, N, q, h)
                    });
                    a(C).bind("touchend.iosSliderEvent", function () {
                        if (na)return !0;
                        m.autoSlide(G, H, z, E, B, D, P, S, V, X, t, R, k, aa, N, q, h)
                    });
                    h.autoSlideHoverPause && a(C).bind("mouseenter.iosSliderEvent", function () {
                        m.autoSlidePause(k)
                    });
                    a(C).data("iosslider", {
                        obj: Ea,
                ...
                p[k] = 0;
                x[k] = 0;
                var u = [0, 0], Q = [0, 0], U = "scrollbarBlock" + b, E = "scrollbar" + b, M, W, P, B, w, Z, q = 0, C = a(this), D, O, S, V, Ba, va = !0;
                g = -1;
                var t, X = [], wa = 0, ia = 0, Fa = 0, G = a(this).children(":first-child"), H, ka, R, N = a(G).children().not("script").length, ga = !1, Da = 0, ya = !1, sa = void 0, aa;
                L[k] = 0;
                var fa = !1, na = !1;
                ma[k] = !1;
                var ja, ta = !1, oa = !1, da = "touchstart.iosSliderEvent click.iosSliderEvent", ea, xa, Ca, ra;
                ha[k] = !1;
                Y[k] = [];
                h.scrollbarDrag && (h.scrollbar = !0, h.scrollbarHide = !1);
                var Ea = a(this);
                if (void 0 != Ea.data("iosslider"))return !0;
                var pa = [], qa = Math.floor(12317 * Math.random());
                ...
                a(".i" + qa).css({
                    ...
                    background: "#fff",
                    opacity: .2
                }).eq(1).css({bottom: "auto", right: "auto", top: "10px", left: "10px"});
                for (g = 0; g < pa.length; g++)a(".i" + qa).html(a(".i" + qa).html() + pa[g]);
                ...
                h.scrollbar && ("" != h.scrollbarContainer ? a(h.scrollbarContainer).append("<div class = '" + U + "'><div class = '" + E + "'></div></div>") : a(G).parent().append("<div class = '" + U + "'><div class = '" + E + "'></div></div>"));
                if (!I())return !0;
                a(this).find("a").bind("mousedown", m.preventDrag);
                a(this).find("[onclick]").bind("click", m.preventDrag).each(function () {
                    a(this).data("onclick", this.onclick)
                });
                g = m.calcActiveOffset(h, m.getSliderOffset(a(G), "x"), t, D, L[k], N, void 0, k);
                g = (g + L[k] + N) % N;
                g = new m.args("load", h, G, a(G).children(":eq(" + g + ")"), g, g);
                a(C).data("args", g);
                if ("" != h.onSliderLoaded) h.onSliderLoaded(g);
                if (T[k].responsiveSlides || T[k].responsiveSlideContainer) g = l ? "orientationchange" : "resize", a(window).bind(g + ".iosSliderEvent-" + k, function () {
                    if (!I())return !0;
                    var b = a(C).data("args");
                ...
                !h.keyboardControls && !h.tabToAdvance || fa || a(document).bind("keydown.iosSliderEvent", function (a) {
                    ...
                    if (ha[k])return !0;
                    if (37 == a.keyCode && h.keyboardControls) a.preventDefault(), a = (J[k] + L[k] + N) % N, (0 < a || h.infiniteSlider) && m.changeSlide(a - 1, G, H, z, E, B, D, P, S, V, X, t, R, k, aa, N, q, h); else if (39 == a.keyCode && h.keyboardControls || 9 == a.keyCode && h.tabToAdvance) a.preventDefault(), a = (J[k] + L[k] + N) % N, (a < t.length - 1 || h.infiniteSlider) && m.changeSlide(a + 1, G, H, z, E, B, D, P, S, V, X, t, R, k, aa, N, q, h)
                });
                if (f || h.desktopClickDrag) {
                    var la = !1, za = !1;
                    g = a(G);
                    var ua = a(G), Aa = !1;
                    h.scrollbarDrag && (g = g.add(M), ua = ua.add(W));
                    a(g).bind("mousedown.iosSliderEvent touchstart.iosSliderEvent", function (b) {
                        ...
                        if (ha[k] || fa || (Aa = m.isUnselectable(b.target, h)))return ga = la = !1, !0;
                        ja = a(this)[0] === a(M)[0] ? M : G;
                        n || r || (b = b.originalEvent);
                        m.autoSlidePause(k);
                        ra.unbind(".disableClick");
                        if ("touchstart" == b.type) eventX = b.touches[0].pageX, eventY = b.touches[0].pageY; else {
                            if (window.getSelection) window.getSelection().empty ? window.getSelection().empty() : window.getSelection().removeAllRanges && window.getSelection().removeAllRanges(); else if (document.selection)if (r)try {
                        ...
                        c = 0;
                        ga = !1;
                        for (b = 0; b < z.length; b++)clearTimeout(z[b]);
                        b = m.getSliderOffset(G, "x");
                        b > -1 * p[k] + q + ea ? (b = -1 * p[k] + q + ea, m.setSliderOffset(a("." + E), b), a("." + E).css({width: B - V + "px"})) : b < -1 * x[k] && (m.setSliderOffset(a("." + E), P - S - B), a("." + E).css({width: B - V + "px"}));
                        b = a(this)[0] === a(M)[0] ? p[k] : 0;
                        ia = -1 * (m.getSliderOffset(this, "x") - eventX - b);
                    ...
                    a(document).bind("touchmove.iosSliderEvent mousemove.iosSliderEvent", function (b) {
                        ...
                        if ("touchmove" == b.type) eventX = b.touches[0].pageX, eventY = b.touches[0].pageY; else {
                            if (window.getSelection) window.getSelection().empty || window.getSelection().removeAllRanges && window.getSelection().removeAllRanges(); else if (document.selection)if (r)try {
                                document.selection.empty()
                            } catch (Ha) {
                            } else document.selection.empty();
                            eventX = b.pageX;
                            eventY = b.pageY;
                            if (!ya || !v && ("undefined" != typeof b.webkitMovementX || "undefined" != typeof b.webkitMovementY) && 0 === b.webkitMovementY && 0 === b.webkitMovementX)return !0
                        }
                        u[0] = u[1];
                        u[1] = eventX;
                        c = (u[1] - u[0]) / 2;
                        ...
                        d = (Q[1] - Q[0]) / 2;
                        if (!ga) {
                            var g = (J[k] + L[k] + N) % N, g = new m.args("start", h, G, a(G).children(":eq(" + g + ")"), g, void 0);
                            a(C).data("args", g);
                            if ("" != h.onSlideStart) h.onSlideStart(g)
                        }
                        (d > h.verticalSlideLockThreshold || d < -1 * h.verticalSlideLockThreshold) && "touchmove" == b.type && !ga && (ta = !0);
                        (c > h.horizontalSlideLockThreshold || c < -1 * h.horizontalSlideLockThreshold) && "touchmove" == b.type && b.preventDefault();
                        if (c > h.slideStartVelocityThreshold || c < -1 * h.slideStartVelocityThreshold) ga = !0;
                        if (ga && !ta) {
                            var g = m.getSliderOffset(G, "x"), I = a(ja)[0] === a(M)[0] ? p[k] : q, l = a(ja)[0] === a(M)[0] ? (p[k] - x[k] - q) / (P - S - B) : 1, F = a(ja)[0] === a(M)[0] ? h.scrollbarElasticPullResistance : h.elasticPullResistance, z = h.snapSlideCenter && a(ja)[0] === a(M)[0] ? 0 : q, K = h.snapSlideCenter && a(ja)[0] === a(M)[0] ? q : 0;
                            "touchmove" == b.type && (Fa != b.touches.length && (ia = -1 * g + eventX), Fa = b.touches.length);
                            if (h.infiniteSlider) {
                                if (g <= -1 * x[k]) {
                                    var y = a(G).width();
                                    if (g <= -1 * ca[k]) {
                                        ...
                                        var w = 0, U = m.getSliderOffset(a(H[0]), "x");
                                        a(H).each(function (a) {
                                            m.getSliderOffset(this, "x") < U && (U = m.getSliderOffset(this, "x"), w = a)
                                        });
                                        F = p[k] + y;
                                        m.setSliderOffset(a(H)[w], F);
                                        p[k] = -1 * t[1] + q;
                                        x[k] = p[k] + y - D;
                                        t.splice(0, 1);
                                        t.splice(t.length, 0, -1 * F + q);
                                ...
                                if (g >= -1 * p[k] || 0 <= g)if (y = a(G).width(), 0 <= g)for (A = -1 * X[0], a(H).each(function (b) {
                                    m.setSliderOffset(a(H)[b], A + q);
                                    b < t.length && (t[b] = -1 * A);
                                    A += R[b]
                                }), ia += -1 * t[0], p[k] = -1 * t[0] + q, x[k] = p[k] + y - D, L[k] = N; 0 < -1 * t[0] - y + q;) {
                                    var W = 0, O = m.getSliderOffset(a(H[0]), "x");
                                    a(H).each(function (a) {
                                        m.getSliderOffset(this, "x") > O && (O = m.getSliderOffset(this, "x"), W = a)
                                    });
                                    F = p[k] - R[W];
                                    m.setSliderOffset(a(H)[W], F);
                                    t.splice(0, 0, -1 * F + q);
                                    ...
                                    L[k]--;
                                    J[k]++
                                } else W = 0, O = m.getSliderOffset(a(H[0]), "x"), a(H).each(function (a) {
                                    m.getSliderOffset(this, "x") > O && (O = m.getSliderOffset(this, "x"), W = a)
                                }), F = p[k] - R[W], m.setSliderOffset(a(H)[W], F), t.splice(0, 0, -1 * F + q), t.splice(t.length - 1, 1), p[k] = -1 * t[0] + q, x[k] = p[k] + y - D, L[k]--
                            } else y = a(G).width(), g > -1 * p[k] + q && (f = (p[k] + -1 * (ia - I - eventX + z) * l - I) * F * -1 / l), g < -1 * x[k] && (f = (x[k] + K + -1 * (ia - I - eventX) * l - I) * F * -1 / l);
                            m.setSliderOffset(G, -1 * (ia - I - eventX - f) * l - I + K);
                            h.scrollbar && (m.showScrollbar(h, E), e = Math.floor((ia - eventX - f - p[k] + z) / (x[k] - p[k] + q) * (P - S - B) * l), g = B, 0 >= e ? (g = B - V - -1 * e, m.setSliderOffset(a("." + E), 0), a("." + E).css({width: g + "px"})) : e >= P - S - V - B ? (g = P - S - V - e, m.setSliderOffset(a("." + E), e), a("." + E).css({width: g + "px"})) : m.setSliderOffset(a("." + E), e));
                            "touchmove" == b.type && (Ba = b.touches[0].pageX);
                            b = !1;
                            f = m.calcActiveOffset(h, -1 * (ia - eventX - f), t, D, L[k], N, void 0, k);
                            g = (f + L[k] + N) % N;
                            h.infiniteSlider ? g != ba[k] && (b = !0) : f != J[k] && (b = !0);
                            if (b && (J[k] = f, ba[k] = g, oa = !0, g = new m.args("change", h, G, a(G).children(":eq(" + g + ")"), g, g), a(C).data("args", g), "" != h.onSlideChange)) h.onSlideChange(g)
                        }
                    });
                    pa = a(window);
                    if (r || n) pa = a(document);
                    a(g).bind("touchcancel.iosSliderEvent touchend.iosSliderEvent", function (a) {
                        a = a.originalEvent;
                        if (za)return !1;
                        za = !0;
                        if (ha[k] || fa || Aa)return !0;
                        if (0 != a.touches.length)for (var b = 0; b < a.touches.length; b++)a.touches[b].pageX == Ba && m.slowScrollHorizontal(G, H, z, E, c, d, B, D, P, S, V, X, t, R, k, aa, N, ja, oa, q, h); else m.slowScrollHorizontal(G, H, z, E, c, d, B, D, P, S, V, X, t, R, k, aa, N, ja, oa, q, h);
                        la = ta = !1;
                        return !0
                    });
                    a(pa).bind("mouseup.iosSliderEvent-" + k, function (b) {
                        ...
                        if (!ma[k]) {
                            if (fa)return !0;
                            h.desktopClickDrag && a(G).css({cursor: y});
                            h.scrollbarDrag && a(M).css({cursor: y});
                            ya = !1;
                            if (void 0 == sa)return !0;
                            m.slowScrollHorizontal(sa, H, z, E, c, d, B, D, P, S, V, X, t, R, k, aa, N, ja, oa, q, h);
                            sa = void 0
                        }
                        la = ta = !1
                    })
            ...
            return a(c).each(function () {
                ...
                for (var d = Y[d.sliderNumber], e = 0; e < d.length; e++)clearTimeout(d[e]);
            ...
            return a(b).each(function () {
                ...
                Z.destroy(!1, this);
                1 != c.numberOfSlides && c.settings.infiniteSlider && (c.settings.startAtSlide = (J[c.sliderNumber] + 1 + L[c.sliderNumber] + c.numberOfSlides) % c.numberOfSlides);
                Z.init(c.settings, this);
            ...
            return this.each(function () {
                ...
                0 == a(e.scrollerNode).children().length ? (a(e.scrollerNode).append(b), d.data("args").currentSlideNumber = 1) : e.settings.infiniteSlider ? (1 == c ? a(e.scrollerNode).children(":eq(0)").before(b) : a(e.scrollerNode).children(":eq(" + (c - 2) + ")").after(b), -1 > L[e.sliderNumber] && J[e.sliderNumber]--, d.data("args").currentSlideNumber >= c && J[e.sliderNumber]++) : (c <= e.numberOfSlides ? a(e.scrollerNode).children(":eq(" + (c - 1) + ")").before(b) : a(e.scrollerNode).children(":eq(" + (c - 2) + ")").after(b), d.data("args").currentSlideNumber >= c && d.data("args").currentSlideNumber++);
            ...
            return this.each(function () {
                ...
                J[d.sliderNumber] > b - 1 && J[d.sliderNumber]--;
            ...
            return a(c).each(function () {
                ...
                m.changeSlide(b, a(c.scrollerNode), a(c.slideNodes), Y[c.sliderNumber], c.scrollbarClass, c.scrollbarWidth, c.stageWidth, c.scrollbarStageWidth, c.scrollMargin, c.scrollBorder, c.originalOffsets, c.childrenOffsets, c.slideNodeOuterWidths, c.sliderNumber, c.infiniteSliderWidth, c.numberOfSlides, c.centeredSlideOffset, c.settings)
            })
        }, prevSlide: function () {
            return this.each(function () {
                var b = a(this).data("iosslider");
                if (void 0 == b || b.shortContent)return !1;
                var c = (J[b.sliderNumber] + L[b.sliderNumber] + b.numberOfSlides) % b.numberOfSlides;
                (0 < c || b.settings.infiniteSlider) && m.changeSlide(c - 1, a(b.scrollerNode), a(b.slideNodes), Y[b.sliderNumber], b.scrollbarClass, b.scrollbarWidth, b.stageWidth, b.scrollbarStageWidth, b.scrollMargin, b.scrollBorder, b.originalOffsets, b.childrenOffsets, b.slideNodeOuterWidths, b.sliderNumber, b.infiniteSliderWidth, b.numberOfSlides, b.centeredSlideOffset, b.settings);
                J[b.sliderNumber] = c
            })
        }, nextSlide: function () {
            return this.each(function () {
                ...
                if (void 0 == b || b.shortContent)return !1;
                var c = (J[b.sliderNumber] + L[b.sliderNumber] + b.numberOfSlides) % b.numberOfSlides;
                (c < b.childrenOffsets.length - 1 || b.settings.infiniteSlider) && m.changeSlide(c + 1, a(b.scrollerNode), a(b.slideNodes), Y[b.sliderNumber], b.scrollbarClass, b.scrollbarWidth, b.stageWidth, b.scrollbarStageWidth, b.scrollMargin, b.scrollBorder, b.originalOffsets, b.childrenOffsets, b.slideNodeOuterWidths, b.sliderNumber, b.infiniteSliderWidth, b.numberOfSlides, b.centeredSlideOffset, b.settings);
                J[b.sliderNumber] = c
            })
        }, lock: function () {
            return this.each(function () {
    ...
    a.fn.iosSlider = function (b) {
        if (Z[b])return Z[b].apply(this, Array.prototype.slice.call(arguments, 1));
        if ("object" !== typeof b && b) a.error("invalid method call!"); else return Z.init.apply(this, arguments)
    }
})(jQuery);
(function (a) {
    var b, c, d, e, f, l, g, n = function () {
    }, r = !!window.jQuery, v = a(window), u = function (a, c) {
        b.ev.on("mfp" + a + ".mfp", c)
    }, y = function (b, c, d, e) {
    ...
    n.prototype = {
        constructor: n, init: function () {
            ...
            if (!1 === c.isObj) {
                ...
                b.index = 0;
                var f, g = c.items;
                for (h = 0; g.length > h; h++)if (f = g[h], f.parsed && (f = f.el[0]), f === c.el[0]) {
                    b.index = h;
                    break
                }
            ...
            b.bgOverlay || (b.bgOverlay = y("bg").on("click.mfp", function () {
                b.close()
            }), b.wrap = y("wrap").attr("tabindex", -1).on("click.mfp", function (a) {
            ...
            for (h = 0; f.length > h; h++)g = f[h], g = g.charAt(0).toUpperCase() + g.slice(1), b["init" + g].call(b);
            A("BeforeOpen");
            b.st.showCloseBtn && (b.st.closeBtnInside ? (u("MarkupParse", function (a, b, c, d) {
            ...
            h = b.wH = v.height();
            f = {};
            b.fixedContentPos && b._hasScrollBar(h) && (g = b._getScrollbarSize()) && (f.marginRight = g);
            b.fixedContentPos && (b.isIE7 ? a("body, html").css("overflow", "hidden") : f.overflow = "hidden");
            g = b.st.mainClass;
            return b.isIE7 && (g += " mfp-ie7"), g && b._addClassToMFP(g), b.updateItemHTML(), A("BuildControls"), a("html").css(f), b.bgOverlay.add(b.wrap).prependTo(b.st.prependTo || d), b._lastFocusedEl = document.activeElement, setTimeout(function () {
                b.content ? (b._addClassToMFP("mfp-ready"), b._setFocus()) : b.bgOverlay.addClass("mfp-ready");
                e.on("focusin.mfp", b._onFocusIn)
            }, 16), b.isOpen = !0, b.updateSize(h), A("Open"), c
        }, close: function () {
            b.isOpen && (A("BeforeClose"), b.isOpen = !1, b.st.removalDelay && !b.isLowIE && b.supportsTransition ? (b._addClassToMFP("mfp-removing"), setTimeout(function () {
                    b._close()
                }, b.st.removalDelay)) : b._close())
        }, _close: function () {
            A("Close");
            var c = "mfp-removing mfp-ready ";
            if (b.bgOverlay.detach(), b.wrap.detach(), b.container.empty(), b.st.mainClass && (c += b.st.mainClass + " "), b._removeClassFromMFP(c), b.fixedContentPos) c = {marginRight: ""}, b.isIE7 ? a("body, html").css("overflow", "") : c.overflow = "", a("html").css(c);
            ...
            b.isIOS ? (a = document.documentElement.clientWidth / window.innerWidth * window.innerHeight, b.wrap.css("height", a), b.wH = a) : b.wH = a || v.height();
            ...
            var d = c.type;
            if (A("BeforeChange", [b.currItem ? b.currItem.type : "", d]), b.currItem = c, !b.currTemplate[d]) {
                var e = b.st[d] ? b.st[d].markup : !1;
                A("FirstMarkupParse", e);
            ...
            if (e.tagName ? e = {el: a(e)} : (d = e.type, e = {data: e, src: e.src}), e.el) {
                for (var h = b.types, f = 0; h.length > f; f++)if (e.el.hasClass("mfp-" + h[f])) {
                    d = h[f];
                    break
                }
            ...
            return e.type = d || b.st.type || "inline", e.index = c, e.parsed = !0, b.items[c] = e, A("ElementParse", e), b.items[c]
    ...
    a.fn.magnificPopup = function (c) {
        ...
        if ("string" == typeof c)if ("open" === c) {
            var e, f = r ? d.data("magnificPopup") : d[0].magnificPopup, g = parseInt(arguments[1], 10) || 0;
            f.items ? e = f.items[g] : (e = d, f.delegate && (e = e.find(f.delegate)), e = e.eq(g));
            b._openClick({mfpEl: e}, d, f)
        } else b.isOpen && b[c].apply(b, Array.prototype.slice.call(arguments, 1)); else c = a.extend(!0, {}, c), r ? d.data("magnificPopup", c) : d[0].magnificPopup = c, b.addGroup(d, c);
        return d
    };
    var Y, J, ba, L = function () {
        ba && (J.after(ba.addClass(Y)).detach(), ba = null)
    };
            ...
            initInline: function () {
                ...
                if (L(), c.src) {
                    ...
                    if (f.length) {
                        ...
                        g && g.tagName && (J || (Y = e.hiddenClass, J = y(Y), Y = "mfp-" + Y), ba = f.after(J).detach().removeClass(Y));
    ...
    a.magnificPopup.registerModule("image", {
        options: {
            ...
            initImage: function () {
                ...
                a.img && (a.hasSize = !0, ca && clearInterval(ca), a.isCheckingImgSize = !1, A("ImageHasSize", a), a.imgHidden && (b.content && b.content.removeClass("mfp-loading"), a.imgHidden = !1))
                ...
                var e = 0, f = function () {
                    c && (c.img[0].complete ? (c.img.off(".mfploader"), c === b.currItem && (b._onImageHasSize(c), b.updateStatus("ready")), c.hasSize = !0, c.loaded = !0, A("ImageLoadComplete")) : (e++, 200 > e ? setTimeout(f, 100) : g()))
                }, g = function () {
                    c && (c.img.off(".mfploader"), c === b.currItem && (b._onImageHasSize(c), b.updateStatus("error", h.tError.replace("%url%", c.src))), c.hasSize = !0, c.loaded = !0, c.loadError = !0)
                }, h = b.st.image, l = d.find(".mfp-img");
                if (l.length) {
    ...
    a.magnificPopup.registerModule("zoom", {
        options: {
            ...
            initZoom: function () {
                ...
                c = d.offset();
                var e = parseInt(d.css("padding-top"), 10), f = parseInt(d.css("padding-bottom"), 10);
                c.top -= a(window).scrollTop() - e;
                d = {width: d.width(), height: (r ? d.innerHeight() : d[0].offsetHeight) - f - e};
    ...
    a.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                var c = b.st.gallery, d = !!a.fn.mfpFastClick;
                return b.direction = !0, c && c.enabled ? (l += " mfp-gallery", u("Open.mfp-gallery", function () {
                        ...
                        a = b.items.length;
                        e.counter = 1 < a ? Q(c.tCounter, f.index, a) : ""
                    }), u("BuildControls.mfp-gallery", function () {
                        if (1 < b.items.length && c.arrows && !b.arrowLeft) {
                            var e = c.arrowMarkup, f = b.arrowLeft = a(e.replace(/%title%/gi, c.tPrev).replace(/%dir%/gi, "left")).addClass("mfp-prevent-close"), e = b.arrowRight = a(e.replace(/%title%/gi, c.tNext).replace(/%dir%/gi, "right")).addClass("mfp-prevent-close"), g = d ? "mfpFastClick" : "click";
                            f[g](function () {
                                b.prev()
                            });
                            e[g](function () {
                            ...
                            b.isIE7 && (y("b", f[0], !1, !0), y("a", f[0], !1, !0), y("b", e[0], !1, !0), y("a", e[0], !1, !0));
        ...
        options: {
            ...
            initRetina: function () {
                if (1 < window.devicePixelRatio) {
                    var a = b.st.retina, c = a.ratio, c = isNaN(c) ? c() : c;
    ...
    (function () {
            ...
            return a(this).each(function () {
                ...
                if (b) {
                    ...
                    g.on("touchstart" + d, function (a) {
                        ...
                        l = m.clientX;
                        k = m.clientY;
                        v.on("touchmove" + d, function (a) {
                            m = a.originalEvent ? a.originalEvent.touches : a.touches;
                            r = m.length;
                            m = m[0];
                            (10 < Math.abs(m.clientX - l) || 10 < Math.abs(m.clientY - k)) && (n = !0, c())
                        }).on("touchend" + d, function (a) {
                            c();
                            n || 1 < r || (f = !0, a.preventDefault(), clearTimeout(h), h = setTimeout(function () {
                                f = !1
                            }, 1E3), e())
                        })
                    })
        ...
        a.fn.destroyMfpFastClick = function () {
            ...
            b && v.off("touchmove" + d + " touchend" + d)
        }
    })();
    T()
...
(function (a, b, c) {
        ...
        if ("" == this.value) {
            if ("password" == this.type) {
                if (!b.data("placeholder-textinput")) {
                    ...
                    b.data({"placeholder-textinput": a, "placeholder-id": f}).before(a)
                }
    ...
    var g = "placeholder" in b.createElement("input"), n = "placeholder" in b.createElement("textarea"), r = c.fn, v = c.valHooks, u = c.propHooks;
    g && n ? (r = r.placeholder = function () {
            ...
            get: function (a) {
                ...
                var d = c(a), g = d.data("placeholder-password");
        ...
        }, g || (v.input = r, u.value = r), n || (v.textarea = r, u.value = r), c(function () {
...
(function () {
    ...
    window.requestAnimationFrame || (window.requestAnimationFrame = function (b, c) {
        var d = (new Date).getTime(), e = Math.max(0, 16 - (d - a)), g = window.setTimeout(function () {
            b(d + e)
        }, e);
        a = d + e;
        return g
...
(function () {
    tdViewport = {
        ...
        init: function () {
            if ("undefined" !== typeof window.td_viewport_interval_list && Array === window.td_viewport_interval_list.constructor) {
                for (var a = 0; a < window.td_viewport_interval_list.length; a++) {
                    var b = new tdViewport.item, c = window.td_viewport_interval_list[a];
        ...
        detectChanges: function () {
            ...
            !1 === a && c !== tdViewport._currentIntervalIndex && (tdViewport._currentIntervalIndex = c, a = !0, tdViewport.log("changing viewport " + tdViewport._currentIntervalIndex + " ~ " + b));
            return a
        },
        _safariWiewPortWidth: {
            divAdded: !1, divJqueryObject: "", getRealWidth: function () {
...
(function () {
    tdMenu = {
        ...
        init: function () {
            var a = jQuery("#td-header-menu .sf-menu"), b = jQuery("#td-header-menu .sf-menu, .top-header-menu"), c = b.find(".menu-item-has-children > a, .td-mega-menu > a");
        ...
        _setHover: function (a, b) {
            if (tdDetect.isTouchDevice) jQuery(document).on("touchstart", "body", function (b) {
                ...
                b.find(".menu-item").hover(function () {
                    var b = jQuery(this), l = "", g, n, r, v;
                    b.hasClass("menu-item-has-children") || b.hasClass("td-mega-menu") ? b.parent().hasClass("sf-menu") ? jQuery.isEmptyObject(c) ? (b.addClass(tdMenu._openMenuClass), b.children("ul").show(), c = b) : b[0] !== c[0] && (r = n = g = 0, v = null, !0 === e && (e = !1, d = setTimeout(function () {
                                    a.parent().removeClass(tdMenu._openMenuClass);
                                    a.parent().children("ul").hide();
                                    ...
                                    5 <= g ? (g = 0, v = tdMenu._getMouseAngleDirection(n, r, f.pageX, f.pageY), n = f.pageX, r = f.pageY) : (g++, 0 === n && 0 === r && (n = f.pageX, r = f.pageY));
                                    null !== v && (85 < v || -85 > v) && (a.parent().removeClass(tdMenu._openMenuClass), a.parent().children("ul").hide(), b.addClass(tdMenu._openMenuClass), b.children("ul").show(), b.off("mousemove"), clearTimeout(d), e = !0, c = b)
                                })) : (l = b.siblings(), l.removeClass(tdMenu._openMenuClass), l.find("ul").hide(), l.find("li").removeClass(tdMenu._openMenuClass), b.addClass(tdMenu._openMenuClass), b.children("ul").show(), tdMenu._getSubmenuPosition(b)) : b.parent().hasClass("sf-menu") || b.parent().hasClass("top-header-menu") ? jQuery.isEmptyObject(c) || (r = n = g = 0, v = null, !0 === e && (e = !1, d = setTimeout(function () {
                                a.parent().removeClass(tdMenu._openMenuClass);
                                a.parent().children("ul").hide();
                                c = {}
                            }, 400)), b.on("mousemove", function (f) {
                                5 <= g ? (g = 0, v = tdMenu._getMouseAngleDirection(n, r, f.pageX, f.pageY), n = f.pageX, r = f.pageY) : (g++, 0 === n && 0 === r && (n = f.pageX, r = f.pageY));
                                null !== v && (85 < v || -85 > v) && (a.parent().removeClass(tdMenu._openMenuClass), a.parent().children("ul").hide(), b.off("mousemove"), clearTimeout(d), e = !0, c = {})
...
(function () {
    tdUtil = {
        ...
        scrollToElement: function (a, b) {
            ...
            var c;
            c = a.offset().top > jQuery(document).height() - jQuery(window).height() ? jQuery(document).height() - jQuery(window).height() : a.offset().top;
            jQuery("html, body").animate({scrollTop: c}, {
                duration: b, easing: "easeInOutQuart", complete: function () {
        ...
        scrollIntoView: function (a) {
            ...
            if (!0 !== tdDetect.isMobileDevice) {
                ...
                jQuery("html, body").animate({scrollTop: a}, {
                    duration: 1100 + b,
...
jQuery().ready(function () {
    ...
    if ("undefined" !== typeof tdsDateFormat) {
        var a = Math.floor((new Date).getTime() / 1E3), a = td_date_i18n(tdsDateFormat, a);
...
function td_resize_videos() {
    jQuery(document).find('iframe[src*="youtube.com"]').each(function () {
        var a = jQuery(this).parent().parent().parent(), b = jQuery(this).parent().hasClass("td_wrapper_playlist_player_vimeo"), c = a.hasClass("vc_video-aspect-ratio-43"), a = a.hasClass("vc_video-aspect-ratio-235");
    ...
    jQuery(document).find('iframe[src*="dailymotion.com"]').each(function () {
        var a = jQuery(this).parent().parent().parent(), b = a.hasClass("vc_video-aspect-ratio-43"), a = a.hasClass("vc_video-aspect-ratio-235");
...
var tdIsScrollingAnimation = !1, td_mouse_wheel_or_touch_moved = !1;
...
function td_smart_lists_magnific_popup() {
    jQuery(".td-lightbox-enabled").magnificPopup({
        ...
        image: {
            tError: "<a href='%url%'>The image #%curr%</a> could not be loaded.", titleSrc: function (a) {
...
function setMenuMinHeight() {
    if ("undefined" === typeof tdEvents.previousWindowInnerWidth) tdEvents.previousWindowInnerWidth = tdEvents.window_innerWidth; else if (tdEvents.previousWindowInnerWidth === tdEvents.window_innerWidth)return;
    tdEvents.previousWindowInnerWidth = tdEvents.window_innerWidth;
    var a = jQuery("#td-mobile-nav"), b = tdEvents.window_innerHeight + 1;
    a.length && a.css("min-height", b + "px");
    if (tdDetect.isMobileDevice) {
        var a = jQuery(".td-menu-background"), c = jQuery(".td-search-background");
...
function td_comments_form_validation() {
    jQuery(".comment-form").submit(function (a) {
        jQuery("form#commentform :input").each(function () {
            var b = jQuery(this), c = jQuery(this).parent().parent();
    ...
    jQuery("form#commentform :input").each(function () {
        var a = jQuery(this).parent().parent(), b = jQuery(this);
        b.focus(function () {
    ...
    tdAjaxSearch = {
        ...
        init: function () {
            ...
            jQuery("#td-header-search").keydown(function (a) {
                if (a.which && 39 === a.which || a.keyCode && 39 === a.keyCode || a.which && 37 === a.which || a.keyCode && 37 === a.keyCode) tdAjaxSearch.td_aj_search_input_focus(); else {
...
function tdModalImage() {
    ...
    jQuery("article").magnificPopup({
        ...
        image: {
            tError: tdUtil.getBackendVar("td_magnific_popup_translation_image_tError"), titleSrc: function (a) {
...
(function () {
    function a() {
        ...
        function c(a, b) {
            var c = b.data("td_block_id"), d = tdBlocks.tdGetBlockObjById(c);
            d.is_ajax_running = !0;
        ...
        jQuery(".td-pulldown-filter-link").click(function (a) {
            ...
            !0 !== c.is_ajax_running && (c.is_ajax_running = !0, c.td_filter_value = jQuery(this).data("td_filter_value"), jQuery("." + jQuery(this).data("td_block_id") + "_rand").find(".td-cur-simple-item").removeClass("td-cur-simple-item"), jQuery(this).addClass("td-cur-simple-item"), c.td_current_page = 1, tdBlocks.tdPullDownFilterChangeValue(b, "<span>" + jQuery(this).html() + ' </span><i class="td-icon-menu-down"></i>'), jQuery("#td_pulldown_" + b).removeClass("td-pulldown-filter-list-open"), tdBlocks.tdAjaxDoBlockRequest(c, "pull_down"), tdDetect.isMobileDevice && tdUtil.stopBubble(a))
        })
    }
    ...
    tdBlocks = {
        tdPullDownFilterChangeValue: function (a, c) {
            ...
            var f;
            !0 === tdAnimationStack.activated && (f = tdAnimationStack.SORTED_METHOD.sort_left_to_right);
            switch (d) {
                case"next":
...
jQuery().ready(function () {
    var a = {
        type: "inline", preloader: !1, focus: "#name", removalDelay: 500, callbacks: {
            beforeOpen: function () {
...
(function () {
    tdLogin = {
        ...
        handlerLogin: function () {
            var a = jQuery("#login_email"), b = jQuery("#login_pass");
        ...
        handlerRegister: function () {
            var a = jQuery("#register_email"), b = jQuery("#register_user");
        ...
        showHideElements: function (a) {
            if (a.constructor === Array)for (var b = a.length, c = 0; c < b; c++)if (a[c].constructor === Array && 2 === a[c].length) {
                var d = jQuery(a[c][0]);
...
(function () {
    tdLoginMob = {
        email_pattern: /^[a-zA-Z0-9][a-zA-Z0-9_\.-]{0,}[a-zA-Z0-9]@[a-zA-Z0-9][a-zA-Z0-9_\.-]{0,}[a-z0-9][\.][a-z0-9]{2,4}$/,
        handlerLogin: function () {
            var a = jQuery("#login_email-mob"), b = jQuery("#login_pass-mob");
        ...
        handlerRegister: function () {
            var a = jQuery("#register_email-mob"), b = jQuery("#register_user-mob");
    ...
    tdDemoMenu = {
        ...
        init: function () {
            a(document).mousemove(function (a) {
                if (a.pageX || a.pageY) tdDemoMenu.mousePosX = a.pageX, tdDemoMenu.mousePosY = a.pageY; else if (a.clientX || a.clientY) tdDemoMenu.mousePosX = a.clientX + document.body.scrollLeft + document.documentElement.scrollLeft, tdDemoMenu.mousePosY = a.clientY + document.body.scrollTop + document.documentElement.scrollTop
            });
            ...
            a(".td-set-theme-style-link").hover(function (c) {
                b !== tdDemoMenu.startTimeout && window.clearTimeout(tdDemoMenu.startTimeout);
                b !== tdDemoMenu.startInterval && window.clearInterval(tdDemoMenu.startInterval);
                var d = a(this), e = d.closest(".td-set-theme-style"), f = a(".td-screen-demo:first"), l, g = 0, n = 0;
                l = a("#wpadminbar");
                var r = f.find("img:first"), d = d.data("img-url");
                r.length ? r.attr("src", d) : f.html('<img src="' + d + '"/>');
                0 === a(".td-set-theme-style-link").index(this) % 2 ? g = 2 * e.outerWidth(!0) : (e = e.prev(".td-set-theme-style"), e.length && (g = e.outerWidth(!0) - 0, n = e.outerWidth(!0) + 0), c.preventDefault(), c.stopPropagation());
                ...
                l = l.length ? l.outerHeight(!0) : 0;
                l > c && (c = l);
                l = {top: c, right: g, "padding-right": n, width: ""};
                c = f.data("width-preview");
                0 < n && (l.width = c + n);
                f.css(l);
                f.data("right-value", g + n);
                f.css("visibility", "visible")
            }, function (c) {
                a(".td-screen-demo-extend:first").hide();
                var d = a(".td-screen-demo:first");
                c = d.css("right");
                var e = d.css("padding-right"), f = d.css("width"), l = parseInt(c.replace("px", "")), g = parseInt(e.replace("px", "")), n = parseInt(f.replace("px", ""));
                c = a(this);
                tdDemoMenu._currentElement = c;
                var r = parseInt(a("#td-theme-settings").css("width").replace("px", ""));
            ...
            a(".td-screen-demo").hover(function (b) {
                ...
                b !== tdDemoMenu.startInterval && (window.clearInterval(tdDemoMenu.startInterval), tdDemoMenu.startInterval = b);
            ...
            a(".td-screen-demo-extend").hover(function (c) {
                if (tdDemoMenu._extendedDemo) {
                    ...
                    var d = a(this), e = a(".td-screen-demo:first"), f = parseInt(a("#td-theme-settings").css("width").replace("px", "")) / 2, l = f;
                    d.css({width: f + "px", top: e.css("top")});
                    d.show();
        ...
        _moveScreenDemo: function (b) {
            var c = a(".td-screen-demo:first"), e = a("#wpadminbar"), f = b.pageY - document.body.scrollTop - c.outerHeight(!0) / 2, e = e.length ? e.outerHeight(!0) : 0;
            e > f && (f = e);
        ...
        _resetTdScreeDemoExtendWidth: function () {
            ...
            a(".td-screen-demo-extend:first").css({width: b + "px"})
        },
        _showExtendedScreenDemo: function () {
            tdDemoMenu._extendedDemo && a(".td-screen-demo-extend:first").css({top: a(".td-screen-demo:first").css("top")}).show()
        },
        _checkMousePosition: function () {
            var c;
            a(".td-set-theme-style-link").each(function (b, e) {
                tdDemoMenu._log(b);
                var d = a(e).closest(".td-set-theme-style"), l = !1, g = !1;
                if (0 === a(".td-set-theme-style-link").index(e) % 2) parseInt(d.position().top) + parseInt(a(window).scrollTop()) < tdDemoMenu.mousePosY && tdDemoMenu.mousePosY < parseInt(d.position().top) + parseInt(a(window).scrollTop()) + parseInt(d.outerHeight()) && (l = !0, parseInt(a(window).width()) - 2 * parseInt(d.outerWidth()) < tdDemoMenu.mousePosX && tdDemoMenu.mousePosX < parseInt(a(window).width()) - parseInt(d.outerWidth()) && (g = !0)); else {
                    var n = d.prev(".td-set-theme-style");
                    n.length && parseInt(n.position().top) + parseInt(a(window).scrollTop()) < tdDemoMenu.mousePosY && tdDemoMenu.mousePosY < parseInt(n.position().top) + parseInt(a(window).scrollTop()) + parseInt(n.outerHeight()) && (l = !0, parseInt(a(window).width()) - parseInt(d.outerWidth()) < tdDemoMenu.mousePosX && tdDemoMenu.mousePosX < parseInt(a(window).width()) && (g = !0))
                }
                if (l && g)return c = e, !1
            });
    ...
    tdTrendingNow = {
        items: [], item: function () {
            ...
            if ("undefined" !== typeof l && null !== l) {
                ...
                e[c].css("opacity", 0);
                e[c].css("z-index", 0);
                for (var n in e)!0 === e.hasOwnProperty(n) && e[n].removeClass("td_animated_xlong td_fadeInLeft td_fadeInRight td_fadeOutLeft td_fadeOutRight");
                e[f].css("opacity", 1);
                e[f].css("z-index", 1);
...
"use strict";
var td_history = {
    td_history_change_event: !1, init: function () {
        ...
        if (!0 === td_history.td_history_change_event) td_history.td_history_change_event = !1; else {
    ...
    tdSmartSidebar = {
        ...
        td_events_scroll: function (a) {
            if (!1 !== tdSmartSidebar.hasItems)if (!1 === tdSmartSidebar.is_enabled) {
                ...
                var e = jQuery(window).height(), f = a + e;
                a += b;
                for (var l = 0; l < tdSmartSidebar.items.length; l++) {
                    ...
                    if (g.content_height <= g.sidebar_height) g.sidebar_state = "case_6_content_too_small"; else if (g.sidebar_height < e) {
                        var n = g.content_top;
                    ...
                    var n = 0, r = tdViewport.getCurrentIntervalItem();
                    null !== r && (n = r.sidebarWidth);
                    switch (g.sidebar_state) {
                        ...
                        case"case_4_fixed_up":
                            ...
                            g.case_5_run_once = !1;
                            g.case_6_run_once = !1;
                            g.sidebar_jquery_obj.css({width: n, position: "fixed", top: b, bottom: "auto"});
                            break;
...
(function () {
    tdInfiniteLoader = {
        hasItems: !1, items: [], item: function () {
...
var Froogaloop = function () {
    ...
    function c(a) {
        ...
        a = b.value;
        var d = b.data, g = "" === g ? null : b.player_id;
        b = g ? e[g][c] : e[c];
        c = [];
        if (!b)return !1;
        void 0 !== a && c.push(a);
    ...
    a.fn = a.prototype = {
        element: null, init: function (a) {
            ...
            var e = this.element, g = "" !== e.id ? e.id : null, f = c && c.constructor && c.call && c.apply ? null : c, l = c && c.constructor && c.call && c.apply ? c : null;
            l && d(a, l, g);
            b(a, f, e);
            return this
...
var tdYoutubePlayers = {}, tdVimeoPlayers = {};
jQuery().ready(function () {
...
(function () {
    tdYoutubePlayers = {
        tdPlayerContainer: "player_youtube", players: [], init: function () {
            for (var a = jQuery(".td_wrapper_playlist_player_youtube"), b = 0; b < a.length; b++) {
                var c = jQuery(a[b]), d = tdYoutubePlayers.addPlayer(c), e = d.tdPlayerContainer;
            ...
            jQuery(".td_click_video_youtube").click(function () {
                var a = jQuery(this).data("video-id"), b = jQuery(this).data("player-id");
                ...
                loadPlayer: function (a) {
                    ...
                    if (void 0 !== b) {
                        ...
                        c.tdYtPlayer = new YT.Player(c.tdPlayerContainer, {
                            playerVars: {autoplay: c.autoplay},
                            height: "100%",
                            width: "100%",
                            videoId: b,
                            events: {onStateChange: c.onPlayerStateChange}
                        })
                    }
                },
                onPlayerStateChange: function (a) {
                    if (a.data === YT.PlayerState.PLAYING) c.pauseStatus(); else if (a.data === YT.PlayerState.ENDED) {
                        c.playStatus();
                        c.autoplay = 1;
                        a = "";
    ...
    tdVimeoPlayers = {
        tdPlayerContainer: "player_vimeo", players: [], existingAutoplay: !1, init: function () {
            ...
            var b = tdVimeoPlayers.tdPlayerContainer + "_" + tdVimeoPlayers.players.length, c = tdVimeoPlayers.createPlayer(b, a);
            ...
            var c = {
                ...
                createPlayer: function (a) {
                    if ("" !== a) {
                        ...
                        var b = "", d = window.td_vimeo_list_ids["td_" + a].title, l = window.td_vimeo_list_ids["td_" + a].time;
...
function td_resize_smartlist_sliders_and_update() {
    jQuery(document).find(".td-smart-list-slider").each(function () {
        ...
        tdDetect.isIe8 || (jQuery("#" + a).css("overflow", "none"), jQuery("#" + a + " .td-item").css("overflow", "visible"));
        var b = 0, b = jQuery("#" + a + "_item_" + td_history.get_current_page("slide")).outerHeight(!0);
        jQuery("#" + a + ", #" + a + " .td-slider").css({height: b});
...
function td_resize_normal_slide(a) {
    ...
    tdDetect.isIe8 || (jQuery("#" + a).css("overflow", "none"), jQuery("#" + a + " .td-item").css("overflow", "visible"));
    var c = jQuery("#" + a + "_item_0").outerWidth(!0), d = 780;
    tdDetect.isAndroid && (d = 1E3);
    b < d && !tdDetect.isIpad && (b = 300 < c ? .5 * c : c, jQuery("#" + a + ", #" + a + " .td-slider, #" + a + " .td-slider .td-module-thumb").css({height: b}))
}
function td_resize_normal_slide_and_update(a) {
    ...
    var c = 0, c = jQuery("#" + b + "_item_0").outerWidth(!0), d = 780;
    tdDetect.isAndroid && (d = 1E3);
    a < d && !tdDetect.isIpad && (c = 300 < c ? .5 * c : c, jQuery("#" + b + ", #" + b + " .td-slider, #" + b + " .td-slider .td-module-thumb").css({height: c}), setTimeout(function () {
    ...
    tdPullDown = {
        ...
        _compute_item: function (a) {
            if (!1 !== a._is_initialized) {
                ...
                var b = 0, c = a.container_jquery_obj.css("width");
                if (void 0 !== c && "" !== c)for (b = c.replace("px", ""), c = a.excluded_jquery_elements.length - 1; 0 <= c; c--)b -= a.excluded_jquery_elements[c].outerWidth(!0);
                ...
                if (0 !== a.minimum_elements && 0 === a._horizontal_elements.length && 0 < a._vertical_elements.length && b >= a._vertical_elements[0].calculated_width) {
                    ...
                    for (var e = 0, f = a.minimum_elements; 0 < f && 0 < a._vertical_elements.length && b >= c;)if (d = tdPullDown._make_element_horizontal(a), null !== d) e += d.calculated_width, f--; else {
                        tdPullDown._prepare_horizontal_header(a);
                        return
                    }
                    b -= e
                }
                for (; (0 < a._horizontal_elements.length || 0 === a._horizontal_elements.length && 0 === a.minimum_elements) && 0 < a._vertical_elements.length && b >= a._vertical_elements[0].calculated_width;)if (d = tdPullDown._make_element_horizontal(a), null !== d) b -= d.calculated_width; else {
                    tdPullDown._prepare_horizontal_header(a);
                    return
                }
...
var td_fps = {
    start_time: 0, current_time: 0, frame_number: 0, init: function () {
        var a = td_fps.start_time = 0, b = 0, c = 0, d = jQuery("#fps_table");
    ...
    tdHomepageFull = {
        items: [], item: function () {
            ...
            if (!tdHomepageFull.items.length) {
                ...
                var c = a('<div class="backstretch"></div>'), e = a('<img class="td-backstretch not-parallax" src="' + b.postFeaturedImage + '"/>');
                c.append(e);
                a("body").prepend(c);
            ...
            for (var c = 0; c < tdHomepageFull.items.length; c++) {
                var e = tdHomepageFull.items[c];
                e.blockUid === a && (e.$tmplBlock.remove(), e.$article.remove(), e.$bgImageWrapper.remove(), tdHomepageFull.items.splice(c, 1), tdBackstr.deleteItem(a) && (item.backstrItem = b))
            }
            return !1
        }
    }
...
(function () {
    tdBackstr = {
        items: [], item: function () {
            ...
            if (a.constructor === tdBackstr.item)if (a.image_jquery_obj.get(0).complete) tdBackstr._load_item_image(a); else a.image_jquery_obj.on("load", function () {
    ...
    tdAnimationStack = {
        ...
        check_for_new_items: function (a, b, c) {
            if (!1 !== tdAnimationStack.activated && !1 !== tdAnimationStack._ready_for_initialization) {
                ...
                (function () {
                    for (var a = !0, l = 0; l < d.length; l++)if (!1 === e[l].complete) {
                        a = !1;
                        break
                    }
                    if (!1 === a) {
                        ...
                        var n = setInterval(function () {
                            var f;
                            if ((new Date).getTime() - g > tdAnimationStack.max_waiting_for_init)for (clearInterval(n), f = 0; f < d.length; f++)d[f].jqueryObj.removeClass(tdAnimationStack._animation_css_class1), d[f].jqueryObj.addClass(tdAnimationStack._animation_css_class2); else {
                                a = !0;
                                for (f = 0; f < d.length; f++)if (!1 === e[f].complete) {
                                    a = !1;
                                    break
                                }
                                !0 === a && (clearInterval(n), tdAnimationStack.log("TIMER - stopped"), tdAnimationStack._precompute_items(d, b, c), tdAnimationStack.compute_items())
                            }
                        }, 100)
        ...
        _precompute_items: function (a, b, c) {
            a.sort(b);
            if (!0 === c)for (; 0 < a.length;)tdAnimationStack.log("add item 1 : " + a.length), tdAnimationStack._items_in_view_port.push(a.shift()); else for (; 0 < a.length;)tdAnimationStack.log("add item 2 : " + a.length), tdAnimationStack.items.push(a.shift())
        },
        init: function () {
        ...
        _separate_items: function () {
            if (0 !== tdAnimationStack.items.length)for (; 0 < tdAnimationStack.items.length;)switch (tdAnimationStack._item_to_view_port(tdAnimationStack.items[0])) {
...
jQuery(".td-subcat-filter").each(function (a, b) {
    var c = jQuery(b), d = c.find(".td-subcat-list:first"), e = new tdPullDown.item;
    e.blockUid = c.parent().data("td-block-uid");
...
jQuery(".td-category-siblings").each(function (a, b) {
    var c = jQuery(b), d = c.find(".td-category:first"), e = new tdPullDown.item;
    e.horizontal_jquery_obj = d;
    e.vertical_jquery_obj = c.find(".td-subcat-dropdown:first");
...
jQuery(window).ready(function () {
    ...
    jQuery(".td-parallax-header").each(function (a, b) {
        ...
        c.animation_callback = function () {
            var a = parseFloat(c.computed_item_properties.move_y).toFixed(), b = parseFloat(c.computed_item_properties.opacity);
            c.jqueryObj.css({
...
function td_compute_backstretch_item(a) {
    var b = 100 * (tdEvents.window_innerHeight - a.offset_top) / (tdEvents.window_innerHeight + a.full_height), c = 100 * tdEvents.window_innerHeight / (tdEvents.window_innerHeight + a.full_height), d = a.offset_top / 4;
    0 == d && (d = 100);
    var e = d / 1.2 * (100 - b) / (c - b), c = -d / 2 + .5;
...
(function () {
    tdWeather = {
        ...
        _renderCurrentItem: function () {
            var a = jQuery("#" + tdWeather._currentItem.block_uid), b = tdWeather._currentLatitude, c = tdWeather._currentLongitude, d = tdWeather._currentLocation;
        ...
        _owmGetFiveDaysData2: function (a) {
            ...
            for (var b = 0, c = 0; c < a.list.length; c++) {
                ...
                var e = td_date_i18n("Ymd"), d = td_date_i18n("Ymd", d);
                e >= d && (b += 1)
            }
            for (c = 0; c < tdWeather._currentItem.forecast.length; c++) {
                e = tdWeather._currentItem.forecast[c];
                if (0 === c && 1 < b && 2 > e.owm_day_index)var f = !0;
                f && (e.owm_day_index += 1);
                if (0 === c && 2 > b && 1 < e.owm_day_index)var l = !0;
                l && --e.owm_day_index;
...
jQuery(window).ready(function () {
    jQuery(".td_smart_list_1 a, .td_smart_list_3 a").click(function (a) {
        if (a.target === a.currentTarget) {
            var b = jQuery(this).attr("target"), c = jQuery(this)[0].hasAttribute("download"), d = jQuery(this).attr("href");
            c || ("_blank" == b ? (a.preventDefault(), window.open(d)) : window.location.href !== d && tdUtil.isValidUrl(d) && (window.location.href = d))
        }
    });
    jQuery(".td_block_trending_now").each(function () {
        var a = new tdTrendingNow.item, b = jQuery(this).find(".td-trending-now-wrapper").data("start"), c = 0;
    ...
    tdAnimationSprite = {
        items: [], isInRequestAnimation: !1, item: function () {
            ...
            if (!0 !== a._isInitialized) {
                ...
                null !== b && (a.offsetTop = a.jqueryObj.offset().top, a.offsetBottomToTop = a.offsetTop + a.jqueryObj.height(), a.animationSpriteClass = b[b.length - 1], b = a.animationSpriteClass.split("-"), 7 === b.length && (a.frames = parseInt(b[1]), a.frameWidth = parseInt(b[2]), a.velocity = parseInt(b[3]), a.loops = parseInt(b[4]), 1 === parseInt(b[5]) ? a.reverse = !0 : a.reverse = !1, 1 === parseInt(b[6]) ? a.automatStart = !0 : a.automatStart = !1, a._isInitialized = !0))
            }
        }, addItem: function (a) {
...
function td_date_i18n(a, b) {
    ...
    d = {
        d: function () {
            ...
            var a = new Date(d.Y(), d.n() - 1, d.j()), b = new Date(d.Y(), 0, 1);
            return Math.round((a - b) / 864E5)
        }, W: function () {
            var a = new Date(d.Y(), d.n() - 1, d.j() - d.N() + 3), b = new Date(a.getFullYear(), 0, 4);
            return l(1 + Math.round((a - b) / 864E5 / 7), 2)
        }, F: function () {
            ...
            var a = 3600 * c.getUTCHours(), b = 60 * c.getUTCMinutes(), d = c.getUTCSeconds();
            return l(Math.floor((a + b + d + 3600) / 86.4) % 1E3, 3)
        }, g: function () {
            return d.G() % 12 || 12
        }, G: function () {
            return c.getHours()
            ...
            return l(c.getMinutes(), 2)
        }, s: function () {
            return l(c.getSeconds(), 2)
        }, u: function () {
            return l(1E3 * c.getMilliseconds(), 6)
        }, e: function () {
            console.log("Not supported (see source code of date() for timezone on how to add support)")
        }, I: function () {
            var a = new Date(d.Y(), 0), b = Date.UTC(d.Y(), 0), c = new Date(d.Y(), 6), e = Date.UTC(d.Y(), 6);
            return a - b !== c - e ? 1 : 0
        }, O: function () {
            var a = c.getTimezoneOffset(), b = Math.abs(a);
            return (0 < a ? "-" : "+") + l(100 * Math.floor(b / 60) + b % 60, 4)
        }, P: function () {
            var a = d.O();
