        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="form-horizontal" action="admin/news/insert" method="post" enctype="multipart/form-data">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="txtTitle" name="txtTitle" placeholder="Nhập vào tiêu đề tin" class="form-control input-md" required="" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="Nom22">Nguồn</label>  
                                        <div class="col-md-4">
                                            <input id="txtSource" name="txtSource" placeholder="Nhập vào nguồn trang" class="form-control input-md" required="" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <textarea class="form-control" rows="10" id="ckeditor-1" name="txtContent"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-4">
                                        <button id="insertNews" name="insertNews" class="btn btn-primary">Insert</button>
