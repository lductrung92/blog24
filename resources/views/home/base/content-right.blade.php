                        ...
                        <div class="td_module_4 td_module_wrap td-animation-stack">
                            <div class=td-module-image>
                                <div class=td-module-thumb>
                                    <a href="{{ $item->category->id }}/{{ $item->id }}" title="{{ $item->title }}">
                                        <img width=324 height=235 class="entry-thumb" src="upload/news/{{ $item->image }}" title="#"/>
                                    </a>
                                </div>
                                <a href="{{ $item->category->id }}" class=td-post-category>{{ $item->category->name }}</a>
                            </div>

                            <h3 class="entry-title td-module-title">
                                <a href="{{ $item->category->id }}/{{ $item->id }}" title="{{ $item->title }}">{{ $item->title }}</a>
                            </h3>
        ...
        <aside class="td_block_template_1 widget widget_categories">
            ...
            <ul>
                ...
                <li class="cat-item cat-item-7">
                    <a href="{{ $cateG->id }}" title="{{ $cateG->name }}">
